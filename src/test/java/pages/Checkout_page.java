...
public class Checkout_page {
   ...
   public Checkout_page(WebDriver driver) {
	...
	public void emailfield() {
		enterEmailAddress.sendKeys("Rolyda1@yahoo.com");
	}
	public void passwordField() {
		enterPassword.sendKeys("Ayana123");
	}
	...
	public void firstNamefield() {
		enterFirstName.sendKeys("Roly");
		
	}
	public void lastNameField() {
		enterlastname.sendKeys("chakma");
		
	}
	public void addressfield() {
		enterAddress1.sendKeys("6000 ohio drive");
	}
	public void cityField() {
		enterCity.sendKeys("Plano");
	}
	public void postcodeField() {
		enterPostCode.sendKeys("75093");
